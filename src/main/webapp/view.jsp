            ...
            <div class="col-lg-9">
                ...
                <div class="row mt-5">
                    <div class="col text-center">
                        <div class="block-27">
                            <ul>
                                <li><a href="${pageContext.request.contextPath}/view/searchViewView.do?currentPage=1">首页</a></li>
                                ...
                                <li><a href="${pageContext.request.contextPath}/view/searchViewView.do?currentPage=${pageInfo.totalPage}" aria-label="Next">尾页</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
