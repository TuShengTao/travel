                    ...
                    <div class="col text-center">
                        <div class="block-27">
                            <ul>
                                ...
                                <li><a href="${pageContext.request.contextPath}/hotle/searchHotelByLikeAndPage.do?currentPage=1">首页</a></li>

                                <c:if test="${pageInfo.currentPage !=1}">
                                    <li><a href="${pageContext.request.contextPath}/hotle/searchHotelByLikeAndPage.do?currentPage=${pageInfo.currentPage-1}">&lt;</a></li>
                                </c:if>
                                <c:if test="${pageInfo.currentPage ==1}">
                                ...
                                <c:forEach begin="1" end="${pageInfo.totalPage}" var="i">
                                    <li><a href="${pageContext.request.contextPath}/hotle/searchHotelByLikeAndPage.do?currentPage=${i}">${i}</a></li>
                                </c:forEach>
                                ...
                                <c:if test="${pageInfo.currentPage == pageInfo.totalPage}">
                                    <li><a href="${pageContext.request.contextPath}/hotle/searchHotelByLikeAndPage.do?currentPage=${pageInfo.totalPage}">&gt;</a></li>
                                </c:if>
                                <li><a href="${pageContext.request.contextPath}/hotle/searchHotelByLikeAndPage.do?currentPage=${pageInfo.totalPage}" aria-label="Next">尾页</a></li>
